...
class Ui_MainWindow(object):
    ...
    def __init__(self):
        ...
        self.mp4_file_name = ""
        self.output_file = ""
        self.audio_file = "Output/Audio/speech.wav"
    ...
    def setupUi(self, MainWindow):
        ...
        self.actionOpen_mp4_video_recording.setObjectName(
            "actionOpen_mp4_video_recording"
        )
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.output_file_name.setPlaceholderText(
            _translate("MainWindow", "interview1.txt")
        )
        self.menuFile.setTitle(_translate("MainWindow", "File"))
        self.menuAbout.setTitle(_translate("MainWindow", "About"))
        self.actionOpen_mp4_video_recording.setText(
            _translate("MainWindow", "Open mp4 video recording")
        )
    ...
    def convert_mp4_to_wav(self):
        ...
        self.convert_thread = convertVideoToAudioThread(
            self.mp4_file_name, self.audio_file
        )
    ...
    def transcribe_audio(self, audio_file):
        ...
        if len(self.output_file_name.toPlainText()) > 0:
            self.output_file = ("Output/Text/" + self.output_file_name.toPlainText())
        else:
            self.output_file = "Output/Text/my_speech_file.txt"
    ...
    def show_about(self):
        ...
        msg = QMessageBox()
        msg.setWindowTitle("About TLDW")
        msg.setText(
            " TLDW by Durhamster\n This is a spin off of vid2speech created by Dr. Alan Davies,\n Senior Lecturer,\n Health Data Science,\n Manchester University, UK"
        )
...
if __name__ == "__main__":
    ...
    # Create directories for the audio and text files
